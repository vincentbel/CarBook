    ...
    CREATE TABLE car
  	 ...
  	 price_highest int(12)  COMMENT '最高价格',
  	 price_lowest int(12)  COMMENT '最低价格',
     transmission varchar(20) COMMENT '变速器',
  	 brand_id int(6) NOT NULL COMMENT '品牌id',
  	 series_id int(6) NOT NULL COMMENT '车系id',
  	 model_number varchar(32) NOT NULL COMMENT '汽车型号',
  	 view_times int(6) COMMENT '观看次数',
  	 time_to_market date COMMENT '上市时间',
  	 company_id int(6) COMMENT '生产厂商id',
